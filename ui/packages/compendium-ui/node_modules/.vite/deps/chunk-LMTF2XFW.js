...
function completeValue(exeContext, returnType, fieldNodes, info, path, result2) {
  ...
  invariant2(0, "Cannot complete value of unexpected output type: " + inspect(returnType));
}
    ...
    Argument: function Argument2(node) {
      ...
      if (argDef && deprecationReason != null) {
        ...
        if (directiveDef != null) {
          ...
          var parentType = context.getParentType();
          var fieldDef = context.getFieldDef();
          parentType != null && fieldDef != null || invariant2(0);
...
function introspectionFromSchema(schema, options) {
  ...
  !result2.errors && result2.data || invariant2(0);
  return result2.data;
}
...
function extendSchemaImpl(schemaConfig, documentAST, options) {
  ...
  function buildType(astNode) {
    ...
    invariant2(0, "Unexpected type definition node: " + inspect(astNode));
  }
}
...
function printSpecifiedByUrl(scalar) {
  ...
  urlAST || invariant2(0, "Unexpected null value returned from `astFromValue` for specifiedByUrl");
...
var hasAnyDirectives, hasAllDirectives;
var init_directives2 = __esm({
  "../../node_modules/@apollo/client/utilities/graphql/directives.js"() {
    init_globals();
    init_graphql2();
    hasAnyDirectives = function(names, root2) {
      return hasDirectives(names, root2, false);
    };
    hasAllDirectives = function(names, root2) {
...
function offsetLimitPagination(keyArgs) {
  ...
  return {
    keyArgs,
    merge: function(existing, incoming, _a5) {
      var args = _a5.args;
...
function relayStylePagination(keyArgs) {
  ...
  return {
    keyArgs,
    read: function(existing, _a5) {
      var canRead = _a5.canRead, readField = _a5.readField;
      if (!existing)
        return existing;
      var edges = [];
      var firstEdgeCursor = "";
    ...
    merge: function(existing, incoming, _a5) {
      var args = _a5.args, isReference2 = _a5.isReference, readField = _a5.readField;
      if (!existing) {
...
var getExtras, notExtras;
var init_pagination = __esm({
  "../../node_modules/@apollo/client/utilities/policies/pagination.js"() {
    init_tslib_es6();
    init_tslib_es6();
    init_mergeDeep();
    getExtras = function(obj) {
...
var currentContext2, MISSING_VALUE2, idCounter2, makeSlotClass2, globalKey2, host2, globalHost, Slot2, bind2, noContext2;
var init_context_esm2 = __esm({
  "../../node_modules/@wry/context/lib/context.esm.js"() {
    currentContext2 = null;
    MISSING_VALUE2 = {};
    idCounter2 = 1;
    makeSlotClass2 = function() {
      return (
        /** @class */
        function() {
          function Slot3() {
    ...
    globalKey2 = "@wry/context:Slot";
    host2 = // Prefer globalThis when available.
    ...
    /* @__PURE__ */ Object.create(null);
    globalHost = host2;
    Slot2 = globalHost[globalKey2] || // Earlier versions of this package stored the globalKey property on the Array
    // constructor, so we check there as well, to prevent Slot class duplication.
    Array[globalKey2] || function(Slot3) {
      try {
...
var _a4, toString4, hasOwnProperty5, fnToStr, previousComparisons, nativeCodeSuffix;
var init_equality_esm = __esm({
  "../../node_modules/@wry/equality/lib/equality.esm.js"() {
    _a4 = Object.prototype;
    toString4 = _a4.toString;
    ...
    ObservableQuery = function(_super) {
      ...
      ObservableQuery2.prototype.getCurrentResult = function(saveAsLastResult) {
        ...
        if (fetchPolicy === "network-only" || fetchPolicy === "no-cache" || fetchPolicy === "standby" || this.queryManager.transform(this.options.query).hasForcedResolvers) {
          ...
          if (__DEV__ && !diff2.complete && !this.options.partialRefetch && !result2.loading && !result2.data && !result2.error) {
            ...
            updateCache: function(cache2) {
              ...
              if (update) {
                if (!skipCache) {
                  ...
                  if (diff2.complete && !isExecutionPatchIncrementalResult(result2)) {
      ...
      QueryManager2.prototype.refetchQueries = function(_a5) {
        ...
        if (includedQueriesById.size) {
          includedQueriesById.forEach(function(_a6, queryId) {
            var oq = _a6.oq, lastDiff = _a6.lastDiff, diff2 = _a6.diff;
            var result2;
            if (onQueryUpdated) {
              if (!diff2) {
...
//# sourceMappingURL=chunk-LMTF2XFW.js.map
